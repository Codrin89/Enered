(function () {
	...
	function createElements(value) {
		for (var i = 0 ; i < data.length ; i++) {
			...
			wrapperDiv.setAttribute('class' , 'col-md-3');
			var wrapperImg = document.createElement('div');
			wrapperImg.setAttribute('class' , 'img-responsive');
			var wrapperContainer = document.createElement('div');
			wrapperContainer.setAttribute('class' , 'container');

			// create image wrapper elements

			var img = document.createElement('img');
			img.setAttribute('src', 'poza.png');
		...
		document.getElementsByClassName('col-md-3')[0].append(wrapper);
	}
